...
public class DarkConfig {
    ...
    public static List<String> defaultBlacklist() {
        return new ArrayList<>(Arrays.asList(
                ...
                "renderCrosshair", "extractCrosshair", "m_93080_",
                "renderSky", "m_202423_",
                "renderHotbar", "extractHotbarAndDecorations", "extractItemHotbar", "m_93009_", "m_193837_",
                "setupOverlayRenderState",
                "net.minecraftforge.client.gui.overlay.ForgeGui",
                "renderFood", "extractFood",
                "renderExperienceBar", "net.minecraft.client.gui.contextualbar.ExperienceBarRenderer", "m_93071_",
                ...
                "renderLogo", "net.minecraft.client.gui.components.LogoRenderer", "m_280037_", "m_280118_",
